        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/rest   rrr.png">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >$<?php echo $product['price']; ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:10px;" value="Thêm vào giỏ hàng" />
										</div>
										</form>
                                    </div>
