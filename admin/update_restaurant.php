                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Nhà hàng</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_restaurant.php">Thêm nhà hàngt</a></li>
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="res_name" value="<?php echo $row['title'];  ?>" class="form-control" placeholder="Tên nhà hàng">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="o_hr" class="form-control custom-select" data-placeholder="Chọn một danh mục">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="c_hr" class="form-control custom-select" data-placeholder="Chọn một danh mục">
                                                    <option>--Chọn giờ của bạn--</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="o_days" class="form-control custom-select" data-placeholder="Chọn một danh mục" tabindex="1">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="c_name" class="form-control custom-select" data-placeholder="Chọn một danh mục" tabindex="1">
