                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="logout.php"><i class="fa fa-power-off"></i>Đăng nhập</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" value="<?php echo $roww['slogan'];?>" class="form-control form-control-danger" placeholder="Mô tả món ăn">
                                                    </div>
                                            </div>
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="file" name="file"  id="lastName" class="form-control form-control-danger" placeholder="Hình ảnh">
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="row">
