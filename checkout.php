...
function function_alert()
{
    ...
    echo "<script>alert('Cảm ơn. Đơn hàng của bạn đã được đặt!');</script>";
...
if (empty($_SESSION["user_id"])) {
    ...
    foreach ($_SESSION["cart_item"] as $item) {
        ...
        if ($_POST['submit']) {
            ...
            unset($item["quantity"]);
            unset($item["price"]);
            $success = "Cảm ơn. Đơn hàng của bạn đã được đặt!";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="payment-option">
                                                <ul class=" list-unstyled">
                                                    <li>
                                                        <label class="custom-control custom-radio  m-b-20">
                                                            <input name="mod" id="radioStacked1" checked value="COD" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Tiền mặt khi giao hàng</span>
                                                        </label>
                                                    </li>
                                                    <li>
                                                ...
                                                <p class="text-xs-center"> <input type="submit" onclick="return confirm('Bạn có muốn xác nhận đơn hàng?');" name="submit" class="btn btn-success btn-block" value="Đặt hàng ngay"> </p>
                                            </div>
                                </form>
                            </div>
                        </div>
